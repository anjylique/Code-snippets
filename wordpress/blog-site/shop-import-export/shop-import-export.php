...
class ShopImportExport
{
    ...
    public function shop_import_export() {
        ...
        if ( strpos( site_url(), 'cloud4.pripress.co.jp/wp' ) > -1 ) {
            $shop_js_path = '/wp'.self::SHOP_JS_PATH;
        } elseif ( strpos( site_url(), 'cloud4.pripress.co.jp/miyagiwp' ) > -1 ) {
            $shop_js_path = '/miyagiwp'.self::SHOP_JS_PATH;
        } elseif ( strpos( site_url(), 'cloud4.pripress.co.jp/saitama' ) > -1 ) {
            $shop_js_path = '/saitama'.self::SHOP_JS_PATH;
        }
